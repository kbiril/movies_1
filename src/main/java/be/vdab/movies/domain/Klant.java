...
public class Klant {
    ...
    public Klant(String familienaam, String voornaam, String straatNummer, String postcode, String gemeente) {
        this(0, familienaam, voornaam, straatNummer, postcode, gemeente);
    }
